ALTER TABLE CINE AUTO_INCREMENT = 1;
...
INSERT INTO USUARIO (login,pass,nombre,ape1,ape2,e_mail,lenguaje,pais,version) VALUES ('rosa','rosa','Rosa','Miceli','Greco','rosa@rosa.com','es','Es',0);
...
INSERT INTO DIRPOSTAL (cp,ciudad,direccion,numero,Ulogin) VALUES (15007,'A Corunha','Calle Puerto',125,'Administrator');

INSERT INTO CINE (nombre,num_salas,c_cp) VALUES ('Port Cinemas',3,15007);
INSERT INTO CINE (nombre,num_salas,c_cp) VALUES ('The Rosales',2,15007);
...
INSERT INTO TICKET (sesion,fila,asiento,estado,precio) VALUES (1,1,2,0,6);


INSERT INTO CLASIFICACION (nombre) VALUES ('HUMOR');
INSERT INTO CLASIFICACION (nombre) VALUES ('ACCION');
INSERT INTO CLASIFICACION (nombre) VALUES ('TERROR');
INSERT INTO CLASIFICACION (nombre) VALUES ('COMEDIA');
INSERT INTO CLASIFICACION (nombre) VALUES ('ROMANTICA');
