...
import javi.model.busquedafacade.plain.actions.BuscaCineIdAction;
import javi.model.busquedafacade.plain.actions.BuscaCinesAction;
...
public class PlainBusquedaFacadeDelegate implements BusquedaFacadeDelegate {
	...
	public List<PedidoCustomVO> recuperarPedidos(String login)
		...
		try {
			...
			return (List<PedidoCustomVO>) PlainActionProcessor.process(
	...
	public List<PedidoVO> recuperarFechaPed(String login)
			throws InternalErrorException {

		try {

			// devuelve todos los pedidos que ha hecho una persona(y no lineas
			// pedidos)
			RecuperarFechaPedAction action = new RecuperarFechaPedAction(login);

			return (List<PedidoVO>) PlainActionProcessor.process(
					getDataSource(), action);
	...
	public List<CineVO> buscaUserCine() throws InternalErrorException {
		...
		try {
			...
			return (List<CineVO>) PlainActionProcessor.process(getDataSource(),
					action);
	...
	public List<TicketVO> tickets() throws InternalErrorException {
		...
		try {
			...
			return (List<TicketVO>) PlainActionProcessor.process(
					getDataSource(), action);
	...
	public PeliculaVO buscaDetallesPelicula(String nombre)
			throws InternalErrorException {

		try {

			BuscaDetallesPeliculaAction action = new BuscaDetallesPeliculaAction(
					nombre);

			return (PeliculaVO) PlainActionProcessor.process(getDataSource(),
					action);
	...
	// XXX que devuelve?una lista con un solo elto??no puede haber mas d 1
	// sesion con el mismo id
	public List<SesionVO> buscaSesion(long idSesion)
			throws InternalErrorException {
	...
	public CineVO buscaCine(String cine) throws InternalErrorException {
		...
		try {
			...
			return (CineVO) PlainActionProcessor.process(getDataSource(),
					action);
	...
	public CineVO buscaCine(Long idCine) throws InternalErrorException {
		...
		try {
			...
			BuscaCineIdAction action = new BuscaCineIdAction(idCine);
	...
	public List<CineVO> buscaCines() throws InternalErrorException {
		...
		try {
			...
			BuscaCinesAction action = new BuscaCinesAction();
	...
	public dvdVO buscardvd(String nombre) throws InternalErrorException {
		...
		try {
			...
			return (dvdVO) PlainActionProcessor
	...
	public List<SesionVO> mostrarCartelera(String cine)
			throws InternalErrorException {
	...
	public List<dvdVO> mostrardvd() throws InternalErrorException {
		...
		try {
			...
			return (List<dvdVO>) PlainActionProcessor.process(getDataSource(),
					action);
	...
	public List<MerchandisingVO> mostrarMerchandising()
			throws InternalErrorException {
		...
		try {
			...
			return (List<MerchandisingVO>) PlainActionProcessor.process(
					getDataSource(), action);
	...
	public List<SalaVO> buscaAdminSala(Long idCine)
			throws InternalErrorException {
		...
		try {
			...
			return (List<SalaVO>) PlainActionProcessor.process(getDataSource(),
					action);
	...
	public EstadoSalaVO consultarSesion(long idSesion)
			throws InternalErrorException {

		try {
			ConsultarSesionAction action = new ConsultarSesionAction(idSesion);
			return (EstadoSalaVO) PlainActionProcessor.process(getDataSource(),
					action);
	...
	private DataSource getDataSource() throws InternalErrorException {
		return DataSourceLocator.getDataSource(GlobalNames.CINES_DATA_SOURCE);
	}
	...
	public TicketVO MarcarButaca(long idTicket) throws InternalErrorException {
		...
		try {
			...
			return (TicketVO) PlainActionProcessor.process(getDataSource(),
					action);
		} catch (ModelException e) {
			throw new InternalErrorException(e);
		}
	...
	public List<ClasificacionVO> recuperarClasificaciones()
		...
		try {
			...
			return (List<ClasificacionVO>) PlainActionProcessor.process(
					getDataSource(), action);
	 ...
	 * 
	 * try{ ReservardvdAction action = new ReservardvdAction(titulo); return
	 * (dvdVO) PlainActionProcessor.process(getDataSource(), action); }catch
	 * (ModelException e) { throw new InternalErrorException(e); }
	 *  }
	 */
}
