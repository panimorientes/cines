...
public class EliminarPeliculaAction extends DefaultAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
        ...
        try {
        	...
        	Long idPelicula=new Long(new String(request.getParameter("idPeli")));
        	
        	adminFacadeDelegate.eliminarPelicula(idPelicula);
