 ...
 */
public class MiniPortalRequestProcessor extends TilesRequestProcessor {

    PreProcessingFilter firstPreProcessingFilter;

    public MiniPortalRequestProcessor() {
    
        firstPreProcessingFilter = 
            new SessionPreProcessingFilter(
            new AuthenticationPreProcessingFilter(new AutenticarAdminPreProcesingFilter(null)));
