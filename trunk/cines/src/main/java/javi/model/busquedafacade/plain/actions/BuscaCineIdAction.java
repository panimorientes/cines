...
public class BuscaCineIdAction implements NonTransactionalPlainAction {

	private Long idCine;

	public BuscaCineIdAction(Long idCine) {
		this.idCine = idCine;
	}
	...
	public Object execute(Connection connection)
		...
		return busquedaCineDAO.find(connection, idCine);
