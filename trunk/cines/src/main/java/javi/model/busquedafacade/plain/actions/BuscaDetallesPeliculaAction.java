...
public class BuscaDetallesPeliculaAction implements NonTransactionalPlainAction {

    private String nombre;
	
    public BuscaDetallesPeliculaAction(String nombre) {
        this.nombre = nombre;
    }
    ...
    public Object execute(Connection connection) 
        ...
        return busquedaPeliculaDAO.find(connection,nombre);                
