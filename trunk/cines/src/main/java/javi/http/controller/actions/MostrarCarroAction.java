...
public class MostrarCarroAction extends DefaultAction{
	...
	public ActionForward doExecute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		/*Exportamos el carro en la request, para que lo imprima la JSP.*/
		try {
			request.setAttribute("carro", SessionManager.getUserFacadeDelegate(request).getCarroCompra());
		} catch (CarroNotFoundException e) {
			throw new InternalErrorException(e);
		}
		
	
	return mapping.findForward("CarroCompra");
