...
public class EliminarMerchandisingAction extends DefaultAction {
    ...
    public ActionForward doExecute(ActionMapping mapping,
        ...
        try {
        	...
        	long idMerchandising=new Long(request.getParameter("idMerchandising"));
        	
        	adminFacadeDelegate.eliminarMerchandising(idMerchandising);
